...
export default function OrderClientScreen(props) {
  ...
  return loading ? (
    <LoadingBox></LoadingBox>
      ...
      <div>
      <Navbar/>
      <h1 style={{fontFamily:"montserrat",fontSize:"5rem",fontWeight:"1000",marginTop:"5rem"}}>Commande {order._id} <fa CartPlus/></h1>
